...
{
    static readonly string s_userAgent = "Samsung Smart Fridge";
    ...
    internal static void TrackLaunch(string installId)
    {
    ...
    static async Task PostLaunchAsync(string installId)
    {
        try
        {
            ...
            request.Headers.TryAddWithoutValidation("User-Agent", s_userAgent);
